...
public class AssetManagementAppDbContext :
    AbpDbContext<AssetManagementAppDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public AssetManagementAppDbContext(DbContextOptions<AssetManagementAppDbContext> options)
        : base(options)
    {
