...
public static class AssetManagementAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AssetManagementAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
