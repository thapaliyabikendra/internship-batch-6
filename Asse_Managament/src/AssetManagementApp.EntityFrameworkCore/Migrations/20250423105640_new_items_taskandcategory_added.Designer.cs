...
{
    [DbContext(typeof(AssetManagementAppDbContext))]
    [Migration("20250423105640_new_items_taskandcategory_added")]
    partial class new_items_taskandcategory_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagementApp.Assets.AssetCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetManagementApp.Assets.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DepartmentSystemName")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("AssetManagementApp.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetManagementApp.Entities.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetManagementApp.Assets.Asset", b =>
                {
                    b.HasOne("AssetManagementApp.Assets.AssetCategory", "AssetCategory")
                        .WithMany()
                        .HasForeignKey("AssetCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AssetManagementApp.Assets.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetManagementApp.Entities.TaskItem", b =>
                {
                    b.HasOne("AssetManagementApp.Entities.Category", "Category")
                        .WithMany()
