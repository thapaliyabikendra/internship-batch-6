...
public class Asset_Management_AppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public Asset_Management_AppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
